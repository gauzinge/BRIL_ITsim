// -*- C++ -*-
//
// Package:    BRIL_ITsim/PuRecHitDigi_cff
// Class:      PuRecHitDigi_cff
//
/**\class PuRecHitDigi_cff PuRecHitDigi_cff.cc
*/
//
...
class PuRecHitDigi_cff : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
    explicit PuRecHitDigi_cff(const edm::ParameterSet&);
    ~PuRecHitDigi_cff();
...
//
PuRecHitDigi_cff::PuRecHitDigi_cff(const edm::ParameterSet& iConfig)
    ...
    std::cout << "PuRecHitDigi_cff::PuRecHitDigi_cff" << std::endl; 
...
PuRecHitDigi_cff::~PuRecHitDigi_cff() {
...
void PuRecHitDigi_cff::beginJob() {

    edm::Service<TFileService> fs;
    
//    std::cout << "PuRecHitDigi_cff::beginJob()" << std::endl;
...
void PuRecHitDigi_cff::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
    
    //std::cout << "PuRecHitDigi_cff::analyze" << std::endl;
...
void PuRecHitDigi_cff::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(PuRecHitDigi_cff);
