// -*- C++ -*-
//
// Package:    BRIL_ITsim/BIBAnalyzerTofRecHitSimhit
// Class:      BIBAnalyzerTofRecHitSimhit
//
/**\class BIBAnalyzerTofRecHitSimhit BIBAnalyzerTofRecHitSimhit.cc BRIL_ITsim/BIBAnalyzerTofRecHitSimhit/plugins/BIBAnalyzerTofRecHitSimhit.cc
...
class BIBAnalyzerTofRecHitSimhit : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
    explicit BIBAnalyzerTofRecHitSimhit(const edm::ParameterSet&);
    ~BIBAnalyzerTofRecHitSimhit();
...
//
BIBAnalyzerTofRecHitSimhit::BIBAnalyzerTofRecHitSimhit(const edm::ParameterSet& iConfig)
    ...
    std::cout << "BIBAnalyzerTofRecHitSimhit::BIBAnalyzerTofRecHitSimhit" << std::endl; 
    ...
    if (bib_type == "halo"){
    		h5file = new H5File("/eos/cms/store/group/dpg_bril/comm_bril/phase2-sim/bib_simulations_fullgeo/hdf5/tof_q_halo_recsim.h5", H5F_ACC_TRUNC);
    }else if (bib_type == "gas_hydrogen"){
    		h5file = new H5File("/eos/cms/store/group/dpg_bril/comm_bril/phase2-sim/bib_simulations_fullgeo/hdf5/tof_q_gas_hydrogen_recsim.h5", H5F_ACC_TRUNC);
    }else if (bib_type == "gas_carbon"){
    		h5file = new H5File("/eos/cms/store/group/dpg_bril/comm_bril/phase2-sim/bib_simulations_fullgeo/hdf5/tof_q_gas_carbon_recsim.h5", H5F_ACC_TRUNC);
    }else if (bib_type == "gas_oxygen"){
    		h5file = new H5File("/eos/cms/store/group/dpg_bril/comm_bril/phase2-sim/bib_simulations_fullgeo/hdf5/tof_q_gas_oxygen_recsim.h5", H5F_ACC_TRUNC);
    }else{
    		h5file = new H5File("/eos/cms/store/group/dpg_bril/comm_bril/phase2-sim/bib_simulations_fullgeo/hdf5/tof_q_bib_recsim.h5", H5F_ACC_TRUNC);
    }
...
BIBAnalyzerTofRecHitSimhit::~BIBAnalyzerTofRecHitSimhit() {
...
void BIBAnalyzerTofRecHitSimhit::beginJob() {

    edm::Service<TFileService> fs;
    
//    std::cout << "BIBAnalyzerTofRecHitSimhit::beginJob()" << std::endl;
    /*
...
void BIBAnalyzerTofRecHitSimhit::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
    
 //   std::cout << "BIBAnalyzerTofRecHitSimhit::analyze" << std::endl;
...
void BIBAnalyzerTofRecHitSimhit::endJob() {
...
void BIBAnalyzerTofRecHitSimhit::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(BIBAnalyzerTofRecHitSimhit);
